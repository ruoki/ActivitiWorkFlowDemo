...
import com.zr.activiti.controller.ProcessController;
...
public class ProcessDefinitionCache {
	 ...
	 * @throws Exception
	 */
	private TaskDefinition getNextTaskInfo(String processInstanceId, String currentActivitiId, String condition,
			String procDefKey) throws Exception {
		try {
