...
import com.zr.workflow.utils.UUIDUtil;
...
public class TestUserService {
	...
	public static void before() {
		...
		//因为目前spring-mybatis.xml只配置了com.zr.workflow.dao包，如果要测试UserService中的方法，则加上:
		//<context:component-scan base-package="com.zr.workflow"></context:component-scan>
        ApplicationContext ctx=new ClassPathXmlApplicationContext("spring/spring-mybatis.xml");
